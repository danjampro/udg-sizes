...
MODEL_NAME = "blue_sedgwick_shen_high_ml_final"
SAVEFIG = False
FIGHEIGHT = 2
FONTSIZE = 14
BINS = 10
PAR_NAMES = "logmstar", "redshift", "rec_phys", "uae_obs_jig", "rec_obs_jig", "colour_obs"
HISTKWARGS = {"density": True, "histtype": "step", "bins": BINS}
